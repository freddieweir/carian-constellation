...
- SNS topic created: `arn:aws:sns:us-east-1:659093129022:constellation-billing-alerts`
...
**Implementation**:
```bash
cat > /Users/fweirvm/git/internal/repos/carian-constellation/CONSTELLATION-CHECKLIST.md << 'EOF'
...
(crontab -l 2>/dev/null; echo "0 22 * * * /Users/fweirvm/git/internal/repos/carian-constellation/scripts/constellation-auto-check.sh") | crontab -
...
aws budgets describe-budgets --account-id 659093129022 \
...
aws sns list-subscriptions-by-topic \
  --topic-arn arn:aws:sns:us-east-1:659093129022:constellation-billing-alerts \
  --region us-east-1 --profile constellation-admin-vm
